...
import { ArrowBack, Star, CloudUpload } from '@mui/icons-material';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Box sx={{ mt: 4 }}>
              <Typography variant='body2' color='text.secondary' sx={{ mb: 2 }}>
                By submitting this review, you confirm that it represents your
                own experience with this service. All reviews are moderated
